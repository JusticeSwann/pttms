...
part 'route_tracking_bloc_event.dart';
part 'route_tracking_bloc_state.dart';

class RouteTrackingBlocBloc extends Bloc<RouteTrackingBlocEvent, RouteTrackingBlocState> {
  final RoutesRepository routesRepository;

  RouteTrackingBlocBloc({required this.routesRepository}) : super(RouteTrackingBlocInitial()) {
  ...
  Future<void> _onUpdateRouteTracking(
      UpdateRouteTracking event, Emitter<RouteTrackingBlocState> emit) async {
  ...
  void _onToggleRoutePolyline(
      ToggleRoutePolyline event, Emitter<RouteTrackingBlocState> emit) {
